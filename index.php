      ...
      <!-- Activity section -->
            <div class="row activity text-center" style="background-color : pink";>
                  <div class="col-md act">
                    <img src="img/create.png" class="img-fluid">
                    <br>
                  ...
                  <div class="col-md act">
                    <img src="img/hist.jpg" class="img-fluid">
                    <br>
                    <a href="transactionhistory.php"><button style="background-color : #2785C4;">Transaction History</button></a>
                  </div>
            </div>
      </div>
      <footer class="text-center mt-0  py-5" style="background-color : pink";>
        <p>&copy 2023. Deepak Singh</b> <br> </p>
      </footer>
